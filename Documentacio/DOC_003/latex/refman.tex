...
\vspace*{7cm}
\begin{center}%
{\Large Experimentos geneticos en el laboratorio \\[1ex]\large versio 4.\+0 24-\/abr-\/2017 }\\
\vspace*{1cm}
...
\input{class_arbre}
\input{classcromosoma}
\input{classespecie}
\input{classindividu}
\input{classmatrerial__genetic}
\input{classparell__cromosomes}
\input{classpoblacio}
...
\input{individu_8hh}
\input{main_8cc}
\input{material__genetic_8hh}
\input{parell__cromosomes_8hh}
\input{poblacio_8hh}
