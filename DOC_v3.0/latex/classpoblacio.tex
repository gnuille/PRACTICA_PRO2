...
Retorna cert si l\textquotesingle{}individu te pares ademés, la operacio es privada ja que treballem amb mapiteradors. 

\begin{DoxyPrecond}{Precondició}
Cert 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondició}
Retornem cert si l\textquotesingle{}individu apuntat per el P.\+I te pares 
\end{DoxyPostcond}
...
Retorna cert si el nom de l\textquotesingle{}individu high es un antecesor de l\textquotesingle{}individu low o es ell mateix, operacio privada ja que treballem amb mapiterator\textquotesingle{}s. 

\begin{DoxyPrecond}{Precondició}
Cert 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondició}
Retornem cert si l\textquotesingle{}individu al qual correspon el nom high es antecesor de low o el nom de low = high. 
\end{DoxyPostcond}
...
Donada una cua i un mapiterador, la plenem completant l\textquotesingle{}arbre geneologic de l\textquotesingle{}individu actual. 

\begin{DoxyPrecond}{Precondició}
Cert 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondició}
To\+\_\+print ha quedat plenada amb l\textquotesingle{}arbre geneologic de l\textquotesingle{}individu \char`\"{}actual\char`\"{} en preordre i respectant els elements que hi habia abans 
\end{DoxyPostcond}
...
Retorna cert si donat un arbre en preordre es subarbre de l\textquotesingle{}inidividu actual, a mes a mes, plenem la cua amb l\textquotesingle{}arbre geneologic de l\textquotesingle{}individu, marcant els individus nous. 
...
Afegim un individu al map sistema. 
...
\subsubsection[{\texorpdfstring{reproduir(string pare, string mare, string fill, const especie \&esp)}{reproduir(string pare, string mare, string fill, const especie &esp)}}]{\setlength{\rightskip}{0pt plus 5cm}void poblacio\+::reproduir (
\begin{DoxyParamCaption}
\item[{string}]{pare, }
\item[{string}]{mare, }
\item[{string}]{fill, }
...
\end{DoxyParamCaption}
)}\hypertarget{classpoblacio_a70b7e64f9857ade2c4b5d6168af09f17}{}\label{classpoblacio_a70b7e64f9857ade2c4b5d6168af09f17}
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondició}
Si es poden reproduir entrarem a fill al sistema mitjançant el metode de reproduccio sino escriurem el error corresponent 
\end{DoxyPostcond}
...
147     \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i = 0; i<(esp.\hyperlink{classespecie_a1af7a5322803c26b43fc5b83e089f6d1}{getN}()+1); ++i) cin>>inutil>>inutil>>inutil;
148   \}
149 \}
\end{DoxyCode}
...
Llegim un arbre en preordre, retornem cert si es un subarbre de algun individu del sistema i a mes a mes si ho es, imprimim l\textquotesingle{}arbre complert marcant entre asteriscs els elements afegits. 
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondició}
Retornem cert si a es antecesor de b o b es antecesor de a, fals en altres casos 
\end{DoxyPostcond}
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondició}
Els M individus queden registrats en el sistema sense antecesors. 
\end{DoxyPostcond}
...
216         in.\hyperlink{classindividu_a1bf8b627f733b55fe98a0fe6ac12898d}{llegir}(esp);
